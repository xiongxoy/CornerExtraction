...
class Test(unittest.TestCase):
    ...
    def test_ransac_on_rectangle(self):
        ...
        rect.extend(line(10, 100, 100, 100))
        rect.extend(line(100, 100, 10, 100))
        rect.extend(line(10, 100, 10, 10))
        rect = np.asarray(rect, np.int)
        print self.analyzer.extract_lines(rect)
    ...
    def test_delete_one_edge(self):
        '''
            ...
            在同一直线上的点
        '''
        points = line(0, 0, 0, 10)
        points.extend(line(10, 0, 10, 10))
        ...
        self.assertEqual(len(inliner_idx), 11)
